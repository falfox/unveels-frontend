    ...
    <div className="mx-auto w-full py-1 sm:py-2">
      <div className="flex w-full items-center space-x-3 sm:space-x-4 overflow-x-auto no-scrollbar py-2 sm:py-2.5">
        {bronzers.map((path, index) => (
          ...
          >
            <img src={path} alt="Bronzer shape" className="size-[35px] sm:size-[50px] lg:size-[65px] rounded" />
          </button>
        ))}
      </div>
    </div>
...
function TextureSelector({ product }: { product: Product }) {
  ...
  return (
    <div className="mx-auto w-full">
      <div className="flex w-full items-center space-x-3 sm:space-x-4 overflow-x-auto no-scrollbar py-2">
