...
const materials = ["Poliester", "Cotton", "Leather", "Denim"];

function HeadbandMaterialSelector() {
  const { selectedMaterial, setSelectedMaterial } = useHeadbandContext();
...
function HeadbandProductList() {
  ...
  const { colorFamily } = useHeadbandContext();
